# Generated by Django 3.0.8 on 2020-07-31 19:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interface_type', models.CharField(choices=[(0, 'SATA'), (1, 'SAS'), (2, 'SCSI'), (3, 'SSD'), (4, 'unknown')], default=4, max_length=16, verbose_name='接口类型')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '硬盘',
